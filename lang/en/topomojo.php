...
$string['submissionsallowed'] = 'Checks allowed per question';
...
$string['submissionsallowed_help'] = 'The maximum number of graded Check attempts for each question when using Adaptive mode or Interactive with multiple tries. Set to 0 for unlimited checks. Penalties are applied after incorrect checks when the selected question behaviour uses penalties. This setting does not control lab launches or whole-quiz submissions.';
...
$string['previewattemptsdeleted'] = 'Finished instructor previews have been deleted.';
