...
$string['endlab_help'] = 'When enabled, the final challenge submission will end the TopoMojo lab (destroy the gamespace). When disabled, the lab will continue running after all submissions are used, allowing students to explore in the lab environment. Note: Enabling this option will lock submissions to 1.';
...
$string['submissionsallowed'] = 'Tries per question';
...
$string['submissionsallowed_help'] = 'Maximum number of times a student can click the Check button for each individual question. Set to 0 for unlimited tries. This applies to each question independently when using interactive mode with multiple tries.';
...
$string['attemptdeleted'] = 'Attempt has been deleted.';
$string['deleteattempt_confirm'] = 'Are you sure you want to delete this attempt? This action cannot be undone.';
...
// Exploration mode (finished attempt but gamespace still running)
$string['exploration_mode_notice'] = 'You have completed this challenge. Your lab is still running for exploration. Click "End Lab" when you are finished.';
$string['your_final_score'] = 'Your Final Score';
$string['current_score'] = 'Current Score';
$string['score_display'] = '{$a->score} out of {$a->maxscore} ({$a->percentage}%)';
$string['endlab_button'] = 'End Lab';
