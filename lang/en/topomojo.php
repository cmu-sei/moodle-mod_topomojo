...
$string['endlab'] = 'End lab when quiz is submitted';
$string['endlab_help'] = 'When enabled, submitting the quiz finishes the Moodle question attempt and stops the associated TopoMojo lab. When disabled, submitting the quiz finishes question grading only; the lab remains running until it is ended manually or expires.';
...
$string['submissionsallowed_help'] = 'The maximum number of challenge submissions allowed by TopoMojo for each lab. Set to 0 for unlimited submissions.';
...
$string['labrunningafterquizsubmission'] = 'Your answers have been submitted. The lab remains running until you end it or it expires.';
...
$string['deleteallattempts'] = 'Delete all attempts, grades, and deployments';
$string['deleteall'] = 'Delete all attempts, grades, and deployments?';
$string['deleteallattempts_confirm'] = 'Are you sure you want to delete all attempts, grades, and bulk deployments for this activity? This action cannot be undone.';
$string['attemptsdeleted'] = 'All attempts, grades, and deployments have been deleted.';
$string['studentattempts'] = 'Student attempts';
$string['instructorpreviews'] = 'Instructor previews';
$string['deletepreviewattempts'] = 'Delete finished instructor previews';
$string['deletepreviewattempts_confirm'] = 'Are you sure you want to delete all finished instructor previews for this activity? This action cannot be undone.';
$string['previewattemptsdeleted'] = '{$a} finished instructor preview(s) deleted.';
