...
/**
 * Defines backup_topomojo_activity_task class
 *
 ...
 */
class backup_topomojo_activity_task extends backup_activity_task {
    ...
    /**
     * Defines a backup step to store the instance data in the topomojo.xml file
     */
